...
me.parent.reportview.run();});},make_report_view:function(){this.page.set_title(__(this.doctype));var module=locals.DocType[this.doctype].module;frappe.breadcrumbs.add(module,this.doctype)
